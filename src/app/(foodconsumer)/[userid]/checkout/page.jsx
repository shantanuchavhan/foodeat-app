...
const Page = ({ params }) => {
  ...
  const [cartPaymentDetailsSection, setCartPaymentDetailSection] =
    useState(false);
  ...
  return (
    <div className="flex text-black gap-10 py-10  px-10 bg-amber-100 h-screen">
      <div className="w-full ">
        {status === "loading" ? (
          <p className="w-4/5  h-100 flex-col justify-center align-center gap-12 p-5 ">
            Loading...
          </p>
          ...
          <div className="flex flex-col gap-5">
            <DeliveryAndPaymentSection
              isAuthRequiredSectionComplete={true}
      ...
      {cartPaymentDetailsSection ? (
        ...
        <div className="w-1/5 flex-col py-10 item-center justify-center">
          <h1 className="text-center font-bold text-slate-600 text-lg">
            Empty Cart
          </h1>
          <div className="py-10">
